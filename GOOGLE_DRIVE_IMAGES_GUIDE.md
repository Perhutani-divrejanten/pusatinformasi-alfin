# 📸 Panduan Google Drive Images untuk Pusat Informasi
...
<parameter name="filePath">c:\KULIAH\MAGANG\Magang di Perhutani\PusatInformasi\GOOGLE_DRIVE_IMAGES_GUIDE.md