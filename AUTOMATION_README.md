...
- **email**: Email portal (akan replace "pusatinformasi@gmail.com")
- **socialHandle**: Handle social media (akan replace "PusatInformasi")
- **colors**: Tema warna
  - **primary**: Warna utama kuning (contoh: #F59E0B → custom)
  - **dark**: Warna gelap hitam (contoh: #78350F → custom)
...
| `PusatInformasi` | `siteName` (tanpa spaces) |
| `PusatInformasi` | `socialHandle` |
| `pusatinformasi@gmail.com` | `email` |
| `#F59E0B` (primary) | Warna primary dari config |
| `#78350F` (dark) | Warna dark dari config |
| `#5F1F7F` (secondary) | Warna secondary dari config |
